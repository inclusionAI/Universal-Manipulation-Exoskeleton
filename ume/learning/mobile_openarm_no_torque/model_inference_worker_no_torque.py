...
import yaml
from ume.learning.mobile_openarm_no_torque.model import ACT_Abs
...
def main(
    model_path: str = "data/experiments/mobile_openarm_no_torque/fridge/ckpt_step_40000/model.pth",
    ...
    while True:
        ...
        joint_state = np.concatenate([obs_actual_qpos_left, obs_actual_qpos_right], axis=-1) # no torque input, only 16-dim qpos input
        obs_dict = {
